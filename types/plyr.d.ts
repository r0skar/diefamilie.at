...
declare namespace Plyr {
  export class Player {
    static setup(targets: NodeList, options?: Plyr.Options): Player[]
    static setup(targets: HTMLElement, options?: Plyr.Options): Player[]
    static setup(targets: HTMLElement[], options?: Plyr.Options): Player[]
    static setup(targets: string, options?: Plyr.Options): Player[]
  ...
  export interface PlyrEvent extends CustomEvent {
    readonly detail: { readonly plyr: Player }
  }
